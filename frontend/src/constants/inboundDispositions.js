...
ONLY these 6 options, not the generic list above. "Callback Scheduled"
deliberately reuses the value CALLBACK_REQUESTED (not a new value) —
DialerPage.jsx's existing check (inboundDisposition ===
...
// Merges BOTH lists — a stored disposition value in the database could
// have come from either campaign's list, so any lookup-by-value (e.g.
// displaying past dispositions in a Call Logs table) needs to resolve
// correctly regardless of which list it was originally selected from.
