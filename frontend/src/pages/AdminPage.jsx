...
export default function AdminPage() {
  ...
  // When editing, the user's OWN currently-bound ViciDial user won't
  // appear in the "available" list (they're the one holding it) — add
  // it back in as a selectable option so editing doesn't force a
  // release just by opening the form.
  ...
  return (
    <>
      ...
      <div className="page-content page-content-wide">
        <h2>Admin — {editingUserId ? "Edit User" : "Create User"}</h2>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {vicidialOptions.length === 0 && (
                    <p style={{ fontSize: 13, color: "#888" }}>
                      No unclaimed ViciDial users available — every active user already has an
                      app account.
                    </p>
                  )}
